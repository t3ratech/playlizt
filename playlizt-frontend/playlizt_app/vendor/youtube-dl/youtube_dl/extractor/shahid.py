...
class ShahidBaseIE(AWSIE):
    ...
    _AWS_API_KEY = os.environ.get('PLAYLIZT_SHAHID_AWS_API_KEY')
    ...
    def _call_api(self, path, video_id, request=None):
        access_key = os.environ.get('PLAYLIZT_SHAHID_AWS_ACCESS_KEY_ID')
        secret_key = os.environ.get('PLAYLIZT_SHAHID_AWS_SECRET_ACCESS_KEY')
        if not (self._AWS_API_KEY and access_key and secret_key):
            raise ExtractorError(
                'Shahid extractor requires PLAYLIZT_SHAHID_AWS_API_KEY, '
                'PLAYLIZT_SHAHID_AWS_ACCESS_KEY_ID, and '
                'PLAYLIZT_SHAHID_AWS_SECRET_ACCESS_KEY',
                expected=True)
