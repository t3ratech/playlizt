...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    if (error != null) {
      ...
      // Trigger field validators so the error appears under the inputs
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_errorMessage != null) ...[
                    ...
                    Semantics(
                      // Explicit label so accessibility tree contains clear error text
                      label: 'Error: Invalid login. ' + _errorMessage!,
                      liveRegion: true,
                      child: Text(
                        _errorMessage!,
