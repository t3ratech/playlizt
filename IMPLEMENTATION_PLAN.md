...
- [x] **Downloader Two-Factor Handoff Slice**: Added an in-memory 2FA code control for authenticated downloads, passes it to the desktop downloader runtime with `--twofactor`, keeps it out of persisted task JSON and tests both behaviors.
