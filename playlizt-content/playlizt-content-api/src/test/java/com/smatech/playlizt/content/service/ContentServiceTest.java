...
class ContentServiceTest {
    ...
    @Test
    void addContent_shouldValidateYouTubeUrl() {
        ContentRequest request = new ContentRequest();
        request.setTitle("Invalid Video");
        request.setVideoUrl("https://vimeo.com/123456"); // Invalid
        
        assertThrows(IllegalArgumentException.class, () -> contentService.addContent(request));
    }
    
    @Test
    void addContent_shouldAcceptYouTubeUrl() {
        ContentRequest request = new ContentRequest();
        ...
        assertDoesNotThrow(() -> contentService.addContent(request));
    }
}
